...
const HomeAdminUser = () => {
  return (
    ...
    <div className="relative xl:w-3/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-14 left-28 px-14">
      <h1 className=" mt-2 justify-center items-center text-blue-600 font-prompt text-6xl font-bold max-sm:text-[30px] max-sm:leading-[140px] ">
        เรื่องบ้าน...ให้เราช่วยดูแลคุณ
      </h1>
      <h3 className="mt-6 text-4xl font-prompt font-semibold max-sm:text-[18px]" >“สะดวก ราคาคุ้มค่า เชื่อถือได้“</h3>
  ...
  <div className="relative h-[540px] flex-1 flex justify-center items-center max-xl:py-20 right-24 max-xl:hidden">
    <img src={plumber} alt="man" width={460} height={722} className="object-contain z-10 mt-16 -mb-10 "/>
  </div>
