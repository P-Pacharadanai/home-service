...
const JobInformation = () => {
  return (
    ...
    <div>
      <img src={partMaleConstructor} className="object-contain " />
    </div>
    <div className="relative flex flex-1 flex-col bg-blue-600 p-20 px-28 text-white leading-20">
      ...
      <h3 className="mt-6 lg:max-w-lg text-2xl font-medium font-prompt">
